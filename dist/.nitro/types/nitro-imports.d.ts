declare global {
  ...
  const cachedEventHandler: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['defineCachedFunction']
  ...
  const defineNitroErrorHandler: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['defineNitroErrorHandler']
  const defineNitroPlugin: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['defineRenderHandler']
  ...
  const defineRouteMeta: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['defineRouteMeta']
  const defineSource: typeof import('../../../server/utils/source')['defineSource']
  const defineTask: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['defineTask']
  ...
  const getRouteRules: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['nitroPlugin']
  ...
  const proxyPicture: typeof import('../../../server/utils/proxy')['proxyPicture']
  ...
  const runTask: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['runTask']
  ...
  const useAppConfig: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['useAppConfig']
  const useBase: typeof import('../../../node_modules/.pnpm/h3@1.15.3/node_modules/h3')['useBase']
  const useDatabase: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['useDatabase']
  const useEvent: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['useEvent']
  const useNitroApp: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['useRuntimeConfig']
  const useSession: typeof import('../../../node_modules/.pnpm/h3@1.15.3/node_modules/h3')['useSession']
  const useStorage: typeof import('../../../node_modules/.pnpm/nitro-go@0.0.1_better-sqlite3@11.10.0_typescript@5.8.3/node_modules/nitro-go/runtime')['useStorage']
...
declare global {
  ...
  // @ts-ignore
  export type { Color, SourceID, AllSourceID, ColumnID, Metadata, PrimitiveMetadata, FixedColumnID, HiddenColumnID, OriginSource, Source, Column, NewsItem, SourceResponse } from 'D:/webProjects/newsnow/shared/types.ts'
  import('D:/webProjects/newsnow/shared/types.ts')
}
export { defineCachedFunction, defineCachedEventHandler, cachedFunction, cachedEventHandler, useRuntimeConfig, useStorage, useNitroApp, defineNitroPlugin, nitroPlugin, defineRenderHandler, defineRouteMeta, getRouteRules, useAppConfig, useEvent, defineTask, runTask, defineNitroErrorHandler, useDatabase } from 'nitropack/runtime';
...
export { decodeBase64URL, encodeBase64URL, decodeBase64, encodeBase64 } from '../../../server/utils/base64';
export { md5, myCrypto } from '../../../server/utils/crypto';
export { tranformToUTC, parseDate, parseRelativeDate } from '../../../server/utils/date';
export { myFetch } from '../../../server/utils/fetch';
export { logger } from '../../../server/utils/logger';
export { proxyPicture } from '../../../server/utils/proxy';
export { rss2json } from '../../../server/utils/rss2json';
export { defineSource, defineRSSSource, defineRSSHubSource } from '../../../server/utils/source';
export { TTL, Interval, Homepage, Version, Author } from '../../../shared/consts';
export { projectDir } from '../../../shared/dir';
export { columns, fixedColumnIds, hiddenColumns, metadata } from '../../../shared/metadata';
export { originSources, genSources } from '../../../shared/pre-sources';
export { default as sources } from '../../../shared/sources';
export { typeSafeObjectFromEntries, typeSafeObjectEntries, typeSafeObjectValues } from '../../../shared/type.util';
export { relativeTime, delay, randomUUID, randomItem } from '../../../shared/utils';
export { verifyPrimitiveMetadata } from '../../../shared/verify';